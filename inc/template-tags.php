...
if ( ! function_exists( 'erinds_blog_footer_info' ) ) {
	function erinds_blog_footer_info() {
			...
			echo '<ul class="pl-0 ml-auto badges-container">';
			forEach($tags as $tag) {
				echo '<span class="badge badge-primary badge-pill ' . $tag->name . '" title="'. $tag->name . ' Category">' . $tag->name . '</span>';
			}
			echo '</ul>';
		}
	}
